...
Route::middleware(['auth:sanctum', 'verified'])->get('/dashboard', [ProductListController::class, 'index'])->name('dashboard');  // Admin Logout Routes 
...
Route::prefix('product')->group(function () {
    ...
    Route::get('/all', [ProductListController::class, 'index'])->name('all.product');
