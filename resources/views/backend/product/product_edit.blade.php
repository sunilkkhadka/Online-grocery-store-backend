                                    ...
                                    <div class="border border-3 p-4 rounded">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="brand" class="form-control" id="inputPrice"
                                                    placeholder="Brand Name" value="{{ $product->brand }}">
                                            </div>

                                            <div class="col-12">
                                                <label for="inputCollection" class="form-label">Quantity </label>
                                                <input type="text" name="quantity" class="form-control" id="inputPrice"
                                                    placeholder="00.00" value="{{ $product->quantity }}">
                                            </div>
